...
if not firebase_admin._apps:
    try:
        ...
        initialize_app(cred, {
            ...
            # 'storageBucket': 'fyp-bbe4d.appspot.com' # Removed storageBucket as we're not using Firebase Storage
        })
        print("Firebase Admin SDK initialized successfully.")
    except Exception as e:
        print(f"Error initializing Firebase Admin SDK: {e}")
        print("Please ensure 'firebase-adminsdk.json' exists directly in the 'backend' folder and is correctly configured.")
