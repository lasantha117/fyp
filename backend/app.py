        ...
        if not firebase_admin._apps:
            try:
                # Get Firebase Admin SDK config from environment variable
                ...
                if firebase_config_json:
                    ...
                    # Fallback to local file for development, but this file should be .gitignored
                ...
                print("Please ensure 'firebase-adminsdk.json' exists locally or FIREBASE_ADMIN_SDK_CONFIG env var is set.")
